<?php
	...
	if(isset($_GET['code'])){
		...
		//thong ke doanh thu
        $sql_lietke_dh = "SELECT * FROM tbl_cart_details,product WHERE tbl_cart_details.id_sanpham=product.id AND tbl_cart_details.code_cart='$code_cart' ORDER BY tbl_cart_details.id_cart_details DESC";
