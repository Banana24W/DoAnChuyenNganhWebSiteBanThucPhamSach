...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"] . "?id={$id}"); ?>" method="post">
    <table class='table table-hover table-responsive table-bordered'>
        ...
        <tr>
            <td>So luong</td>
            <td><input type='text' name='soluong' value='<?php echo $product->soluong; ?>' class='form-control' /></td>
        </tr>
        <tr>
            <td>Discount</td>
            <td><input type='text' name='discount' value='<?php echo $product->discount; ?>' class='form-control' /></td>
        </tr>
        <tr>
            <td></td>
            <td>
